    ...
    <section class="content">
      ...
      <div class="box box-default">
        <div class="box-header with-border">
          <div class="pull-right" style="font-size:15px;"><span class="mandatory">*</span> indicates field for administrator ONLY &nbsp;</div>
        </div>
        <!-- /.box-header -->
        <div class="box-body">
          <!-- form start -->
              ...
              <div class="box-body">
                ...
                <div class="row">
                  ...
                  <div class="row">
                      <div class="col-md-6">
                          <div class="form-group">
                              <label for="site" class="col-lg-4 control-label">Assigned Site <span class="mandatory">*</span></label>
                              <div class="col-lg-7">
