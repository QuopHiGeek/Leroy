...
$primaryKey="user_id";
       ...
       $sWhereLoggedIn=' where ud.user_id = '.$_SESSION['userId'];
        if (isset($sWhere) && $sWhere != "") {
          $sWhereLoggedIn=$sWhereLoggedIn.' AND '.$sWhere;
        }
        $sWhere=$sWhereLoggedIn;
      ...
      // echo $sQuery;
       ...
       // print_r($rResult);
        ...
        $aResultTotal =  $db->rawQuery("SELECT COUNT(ud.user_id) as total FROM user_details ud $sWhere ");
