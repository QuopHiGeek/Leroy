                ...
                <div class="row">
                  <div class="col-md-6">
                    <div class="form-group">
                        <label for="batchCode" class="col-lg-4 control-label">Batch ID <span class="mandatory">*</span></label>
...
<!--								<div class="row" id="alertText" style="font-size:18px;"></div>-->
  ...
  $("#machine").change(function(){
	...
	$('#alertText').html('You have picked '+$("#machine option:selected").text()+' and it has limit of maximum '+noOfSamples+' specimen to make it a batch');
      }else{
	$('.ms-list').html('');
	$('#alertText').html('');
      }
