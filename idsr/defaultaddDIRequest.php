...
foreach($pdResult as $provinceName1){
...
foreach($pdResult as $provinceName2){
                            ...
                            <div id="myTabContent" class="tab-content" >
                                        ...
                                        <div class="box box-primary">
                                            ...
                                            <div class="box-body">
                                                ...
                                                <div class="row">
                                                    <div class="col-xs-3 col-md-3">
                                                        <div class="form-group">
                                                            <label for="firstDate1">Date seen at Health Facility <span class="mandatory">*</span></label>
                                                            <input type="text" class="form-control" style="width:100%;" name="firstDate1" id="firstDate1" placeholder="First Date" title="Please select first date" >
                                                        </div>
                                                    </div>
                                                    <div class="col-xs-3 col-md-3">
                                                        <div class="form-group">
                                ...
                                <div class="tab-pane fade" id="laboratoryInformation">
                                            ...
                                            <div class="box box-primary">
                                                ...
                                                <div class="box-body">
                                                    <div class="row">
                                                        <div class="col-xs-3 col-md-3">
                                                            <div class="form-group">
                                                                <label for="province1">Region <span class="mandatory">*</span></label>
                                                                <select class="form-control isRequired" name="province1" id="province1" title="Please choose region" style="width:100%;" onchange="getProvinceDistricts2(this);">
                                                                    <?php echo $province2;?>
                                                                </select>
                                                            </div>
                                                        </div>
                                                        <div class="col-xs-3 col-md-3">
                                                            <div class="form-group">
                                                                <label for="district1">District <span class="mandatory">*</span></label>
                                                                <select class="form-control isRequired" name="district1" id="district1" title="Please choose county" style="width:100%;" onchange="getFacilities2(this);">
                                                                    <option value=""> -- Select -- </option>
                                                                </select>
                                                            </div>
                                                        </div>
                                                        <div class="col-xs-3 col-md-3">
                                                            <div class="form-group">
                                                                <label for="fName1">Laboratory Name <span class="mandatory">*</span></label>
                                                                <select class="form-control isRequired" id="fName1" name="fName1" title="Please select clinic/health center name" style="width:100%;" onchange="fillFacilityDetails1();">
                                                                    <?php echo $facility1;  ?>
                                                                </select>
                                                            </div>
                                                        </div>
                                                        <div class="col-xs-3 col-md-3">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" class="form-control" style="width:100%;" name="fCode1" id="fCode1" placeholder="ART Center Code" title="Please enter ART center code">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                        <div class="col-xs-3 col-md-3">
                                                            <div class="form-group">
                                                                <label for="firstDate">Date Specimen Collected <span class="mandatory">*</span></label>
                                                                <input type="text" class="form-control" style="width:100%;" name="firstDate" id="firstDate" placeholder="Specimen Collection Date" title="Please select first date" >
                                                            </div>
                                                        </div>
                                                        <div class="col-xs-3 col-md-3">
                                                            <div class="form-group">
                                                    ...
                                                    <div class="row facilityDetails1" style="display:none;">
                                                        <div class="col-xs-2 col-md-2 femails1" style="display:none;"><strong>Clinic Email(s) -</strong></div>
                                                        <div class="col-xs-2 col-md-2 femails1 facilityEmails1" style="display:none;"></div>
                                                        <div class="col-xs-2 col-md-2 fmobileNumbers1" style="display:none;"><strong>Clinic Mobile No.(s) -</strong></div>
                                                        <div class="col-xs-2 col-md-2 fmobileNumbers1 facilityMobileNumbers1" style="display:none;"></div>
                                                        <div class="col-xs-2 col-md-2 fContactPerson1" style="display:none;"><strong>Clinic Contact Person -</strong></div>
                                                        <div class="col-xs-2 col-md-2 fContactPerson1 facilityContactPerson1" style="display:none;"></div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="box box-primary">
                                    ...
                                    <div class="box-footer">
                                        ...
                                        <input type="hidden" name="saveNext" id="saveNext"/>
                                        <input type="hidden" name="sampleCodeTitle1" id="sampleCodeTitle1" value="<?php echo $arr['sample_code'];?>"/>
                                        <input type="hidden" name="testtype" id="testType" value="lab"/>
                                        <?php if($arr['sample_code']=='auto' || $arr['sample_code']=='YY' || $arr['sample_code']=='MMYY'){ ?>
                                            <input type="hidden" name="sampleCodeFormat1" id="sampleCodeFormat1" value="<?php echo $sFormat;?>"/>
                                            <input type="hidden" name="sampleCodeKey1" id="sampleCodeKey1" value="<?php echo $sKey;?>"/>
                                        <?php } ?>
  ...
  // BARCODESTUFF END
    ...
    function getProvinceDistricts2(obj){
        ...
        if(pName!=''){
            ...
            provinceName = true;
            facilityName = true;
            $("#province1").html("<?php echo $province2;?>");
            $("#fName1").html("<?php echo $facility1;?>");
        }
        $.unblockUI();
    }
