<?php
ob_start();
$title = "eVLIS | Edit Configuration";
include('../header.php');
...
<div class="panel panel-default">
  ...
  <div class="panel-body">
                ...
                <div id="auto-sample-eg" class="row" style="display:<?php echo($arr['sample_code'] == 'auto' || 'MMYY' || 'YY')?'block':'none'; ?>;">
                  <div class="col-md-7" style="text-align:center;">
                    <code id="auto-sample-code" class="autoSample" style="display:<?php echo($arr['sample_code'] == 'auto')?'block':'none'; ?>;">
                        eg. Site Code+Year+Month+Date+Increment Counter
                    </code>
                ...
                <div class="row" style="margin-top:10px;">
                  <div class="col-md-7">
                    <div class="form-group">
                      <label for="import_non_matching_sample" class="col-lg-4 control-label">Allow Samples not matching the eVLIS Sample IDs while importing results manually</label>
                      <div class="col-lg-8">
                        <br>
                        <br>
                        ...
                        <br><br> <code>While importing results from CSV/Excel file, should we import results of Sample IDs that do not match the Sample IDs present in eVLIS database</code>
                      </div>
                    </div>
                   </div>
                </div>
...
<div class="panel panel-default">
  <div class="panel-heading">
    <h3 class="panel-title">eVLIS Connect</h3>
  </div>
  <div class="panel-body">
                ...
                <div class="row">
                  <div class="col-md-7 col-md-offset-2" style="text-align:center;">
                      <code>Used for Dropbox or shared folder sync using the eVLIS-connect module</code>
                  </div>
                </div><br/>
                        ...
                        <div class="form-group">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <select id="r_mandatory_fields" name="r_mandatory_fields[]" multiple="multiple" class="search">
                                     ...
                                     <option value="facility_state" <?php echo (in_array('facility_state',$mFieldArray))?'selected="selected"':''; ?>>Facility Region</option>
                                     ...
                                     <option value="approvedBy" <?php echo (in_array('approvedBy',$mFieldArray))?'selected="selected"':''; ?>>Verified By</option>
                                   </select>
