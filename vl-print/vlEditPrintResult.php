<?php
$title = "eLabMessenger | Modify Results";
include('../header.php');
...
<style>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1><i class="fa fa-edit"></i> Modify Result</h1>
      <ol class="breadcrumb">
        <li><a href="/"><i class="fa fa-dashboard"></i> Home</a></li>
        <li class="active">Modify Result</li>
      </ol>
    </section>
    ...
    <section class="content">
      <div class="row">
		...
		<tr>
		    <td><b>Specimen Testing Date&nbsp;:</b></td>
		    <td>
    ...
    $.blockUI();
     oTable = $('#vlRequestDataTable').dataTable({
		...
		{"sClass":"center"},
            ...
            "bProcessing": true,
            "bServerSide": true,
            "sAjaxSource": "getEditVlTestResultDetails.php",
            "fnServerData": function ( sSource, aoData, fnCallback ) {
			      ...
			      aoData.push({"name": "vlEdit", "value": 'edit'});
