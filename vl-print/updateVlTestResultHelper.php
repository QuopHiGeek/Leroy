...
try {
    ...
    if(isset($_POST['tndDbs']) && $_POST['tndDbs'] =='yes' && $isRejection == false){	
        $_POST['vlResult'] = 'HIV-1/Detected';	
    }	
    if(isset($_POST['bdlDbs']) && $_POST['bdlDbs'] =='yes' && $isRejection == false){	
        $_POST['vlResult'] = 'Not Detected';	
    }
    ...
    $vldata=array(
          ...
          'lab_name'=>(isset($_POST['testLab']) && $_POST['testLab']!='') ? $_POST['testLab'] :  NULL,
       ...
       //echo "<pre>";var_dump($vldata);die;
        ...
        if($id>0){
             $_SESSION['alertMsg']="Patient Test Result Verified";
             //Log result updates
             $data=array(
