...
for ($i = 0; $i < sizeof($configResult); $i++) {
  $arr[$configResult[$i]['name']] = $configResult[$i]['value'];
	...
	if(isset($_POST['rjtBatchID']) && trim($_POST['rjtBatchID'])!= ''){
	    $sWhere = $sWhere.' AND b.batch_code LIKE "%'.$_POST['rjtBatchID'].'%"';
	}
	
	if(isset($_POST['rjtSpecimenTestDate']) && trim($_POST['rjtSpecimenTestDate'])!= ''){
	...
	if(isset($_POST['rjtSpecimenType']) && $_POST['rjtSpecimenType']!=''){
		$sWhere = $sWhere.' AND s.sample_id = "'.$_POST['rjtSpecimenType'].'"';
	}
	if(isset($_POST['rjtSiteName']) && $_POST['rjtSiteName']!=''){
