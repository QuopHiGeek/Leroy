...
$title = "eLabMessenger |EID Dashboard";
...
<style>
  ...
  <div class="content-wrapper">
	...
	<div class="col-lg-7">
	  <table class="table" cellpadding="1" cellspacing="3" style="margin-left:1%;margin-top:20px;width: 98%;margin-bottom: 0px;">
        ...
        <a href="index.php" class="btn btn-primary btn-sm"></i>VL Dashboard</a>
		    </td>
		</tr>
	  </table>
	  </div>
  ...
  <script>
    $(function () {
    $.post("../includes/getMissingResultDBS.php",{sampleCollectionDate:'',batchCode:'',facilityName:'',sampleType:''},
      function(data){
	  if($.trim(data)!=''){
    ...
    function searchVlRequestData(){
      ...
      $.post("getSampleResultDBS.php",{sampleCollectionDate:$("#sampleCollectionDate").val()},
      function(data){
	  if(data!=''){
