                    ...
                    <div class="col-xs-12">
                        <div class="box">
                            <table class="table" cellpadding="1" cellspacing="3" style="margin-left:1%;margin-top:20px;width: 98%;">
                                <tr>
                                    <td style=""><b>Instance/Site Name&nbsp;<span class="mandatory">*</span></b> <br>
                                    </td>
                                    <td>
                                      <input type="text" class="form-control isRequired" name="fName" id="fName" title="Please enter instance name" placeholder="Instance/Site Name"/>
                                    </td>
                                    <td>&nbsp;<b>Instance/Site ID&nbsp;</b></td>
                                    <td>
                                      <input type="text" class="form-control " id="fCode" name="fCode" placeholder="Instance/Site Code" title="Please enter site code"/>
                                    </td>
                                </tr>
                                <tr>
                                    <td style=""><b>Instance/Site Type&nbsp;<span class="mandatory">*</span></b></td>
                                    <td>
                                        <select class="form-control isRequired" id="fType" name="fType"  title="Please choose instance type">
                                            <option value="">-- Select --</option>
                                            <option value="Viral Load Lab">Viral Load Laboratory</option>
                                            <option value="Clinic/Lab">ART Site/Lab</option>
