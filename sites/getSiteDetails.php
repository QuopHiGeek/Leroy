...
$primaryKey="facility_id";
      ...
      // echo $sQuery;
        ...
        */
	    ...
	    if(isset($_SESSION['privileges']) && in_array("editSite.php", $_SESSION['privileges'])){
            $row[] = '<a href="editSite.php?id=' . base64_encode($aRow['facility_id']) . '" class="btn btn-primary btn-xs" style="margin-right: 2px;" title="Edit"><i class="fa fa-pencil"> Edit</i></a>';
           }
            $output['aaData'][] = $row;
        }
