...
<head>
  ...
  <title>eLabMessenger | Laboratory Information System | Login</title>
  ...
  <!-- iCheck -->
    <style>
        body{
            ...
            background : url("assets/img/eLabMessenger.jpg") center;
...
<body class="">
    <div class="container-fluid">
        ...
        <div style="margin-top:15px;float:left;">
            <img src="uploads/logo/logo549mvd.png" alt="Logo image" style="max-width:120px;">
        </div>
        <?php
        }
        ...
        <div id="loginbox" style="margin-top:20px;margin-bottom:70px;float:right;margin-right:10px;" class="mainbox col-md-3 col-sm-8 ">
            <div class="panel panel-default" style="opacity: 0.93;">
                <div class="panel-heading">
                    <div class="panel-title">Electronic Laboratory Information System</div>
                </div>
    ...
    <div style="padding:1% 2%;width:100%;position:absolute;bottom:1.5%;color:#fff;background:rgba(0,0,0,0);">
        ...
        <select id="country" name="country" class="form-control" style="width:200px;display:none;">
            ...
            <option value="6">National AIDS/STI's Control Program</option>
