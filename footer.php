...
<script type="text/javascript">
  $(document).ready(function(){
    $("#specimenType").change(function(event){
      var specimen = $("#specimenType option:selected").html().trim();
      if(specimen=="DBS"){
        $('#myTab a[href="#treatmentInformation"]').hide();
        $('#myTab a[href="#viralInformation"]').hide();
        $('#treatBtn').hide();
        
      

      }else{
        $('#myTab a[href="#treatmentInformation"]').show();
        $('#myTab a[href="#viralInformation"]').show();
        $('#treatBtn').show(); 
  ...
  }else if (splitsUrl=='vlPrintDBSResult.php') {
    $(".program").addClass('active');
    $(".allMenu").removeClass('active');
    $(".vlPrintDBSResultMenu").addClass('active');
  ...
  }else if (splitsUrl=='vlPivotTable.php') {
    $(".program").addClass('active');
    $(".allMenu").removeClass('active');
    $(".vlPivotTableMenu").addClass('active');
  }else{
    $(".allMenu").removeClass('active');
