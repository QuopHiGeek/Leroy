                 ...
                 <div class="box box-primary">
                    ...
                    <div class="box-body">
                      <div class="row">
                        <div class="col-xs-4 col-md-4">
                          <div class="form-group">
                            ...
                            <input type="text" class="form-control isRequired" id="sampleCode" name="sampleCode" placeholder="Enter Specimen ID" title="Please enter sample id" value="<?php echo $vlQueryInfo[0]['sample_code']; ?>" style="width:100%;"/>
                          </div>
                        </div>
                      </div>
                      <div class="row">
                        ...
                        <div class="col-xs-4 col-md-4">
                          <div class="form-group">
                            <label for="fName">Health Site <span class="mandatory">*</span></label>
                              <select class="form-control isRequired" id="fName" name="fName" title="Please select health site" style="width:100%;" onchange="fillFacilityDetails();">
                      ...
                      <div class="row">
                        <div class="col-xs-4 col-md-4">
                          <div class="form-group">
                          <label for="fCode">Health Site Code </label>
                            <input type="text" class="form-control" style="width:100%;" name="fCode" id="fCode" placeholder="Health Site Code" title="Please enter health site code" value="<?php echo $efacilityResult[0]['facility_code']; ?>">
                          </div>
                        </div>
                        <div class="col-xs-4 col-md-4">
                          <div class="form-group">
                      ...
                      <div class="row">
                        <div class="col-xs-4 col-md-4">
                          <div class="form-group">
                           <label for="labId">Referral Laboratory for Specimen </label>
                ...
                <div class="box box-primary">
                  ...
                  <div class="box-body">
                    <div class="row">
                      ...
                      <div class="col-xs-4 col-md-4">
                          <div class="form-group">
                           <label for="">Repeat Specimen? (due to rejection) </label><br>
                            <label class="radio-inline">
                      ...
                      <div class="col-xs-4 col-md-4">
                          <div class="form-group">
                           <label for="">Date Specimen Collected <span class="mandatory">*</span></label><br>
                             <input type="text" class="form-control isRequired" style="width:100%;" name="sampleCollectionDate" id="sampleCollectionDate" placeholder="Specimen Collected Date" title="Please enter sample collected date" value="<?php echo $vlQueryInfo[0]['sample_collection_date']; ?>">
                          </div>
                      </div>
                    </div>
                    <div class="row">
                ...
                <div class="box box-primary">
                  ...
                  <div class="box-body">
                    <div class="row">
                      <div class="col-xs-4 col-md-4">
                          <div class="form-group">
                           <label for="">Date Specimen Received at the Lab </label><br>
                             <input type="text" class="form-control" style="width:100%;" name="sampleReceivedOn" id="sampleReceivedOn" placeholder="Specimen Received Date" title="Please enter sample received date at lab" value="<?php echo $vlQueryInfo[0]['sample_received_at_vl_lab_datetime']; ?>">
                          </div>
                      </div>
                      <div class="col-xs-4 col-md-4">
                          <div class="form-group">
                      ...
                      <div class="col-xs-4 col-md-4">
                        <div class="form-group">
                          <label for="sampleValidity">Specimen Validity </label><br>
                            <label class="radio-inline">
                    ...
                    <div class="row rejectionSection" style="display:<?php echo (trim($vlQueryInfo[0]['sample_test_quality'])!='' && $vlQueryInfo[0]['sample_test_quality']!= null && $vlQueryInfo[0]['sample_test_quality']=='invalid')?'':'none'; ?>;">
                      <div class="col-xs-4 col-md-4">
                        <div class="form-group">
                         <label for="">If Rejected, Repeat Specimen Collection </label><br>
                         <label class="radio-inline">
                      ...
                      <div class="col-xs-4 col-md-4">
                          ...
                          <label for="result">Results </label>
                            <select name="result" id="result" class="form-control" title="Please choose test result" style="width:100%;">
                              ...
                              <option value="repeat" <?php echo ($vlQueryInfo[0]['result']== 'repeat')?"selected='selected'":""?>>Repeat Specimen Collection</option>
                            </select>
