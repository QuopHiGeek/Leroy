                ...
                <div class="row">
                  <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <div class="col-lg-7">
                        <input type="text" class="form-control isRequired" id="facilityName" name="facilityName" placeholder="Site Name" title="Please enter site name" />
                        </div>
                    </div>
                  </div>
                   <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <div class="col-lg-7">
                        <input type="text" class="form-control" id="facilityCode" name="facilityCode" placeholder="Site ID" title="Please enter site code" onblur="checkNameValidation('facility_details','facility_code',this,null,'This code already exists.Try another code',null)"/>
                        </div>
                    </div>
                  </div>
                </div>
