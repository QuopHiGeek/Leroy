        ...
        <div class="box-body">
          <!-- form start -->
                    ...
                    <div class="row">
                      <div class="col-xs-3 col-md-3">
                        <div class="form-group">
                          <label for="sampleCode">Specimen Code <span class="mandatory">*</span></label>
                          <input type="text" class="form-control sampleCode isRequired " id="sampleCode" name="sampleCode" placeholder="Enter Specimen Code" title="Please enter sample code" style="width:100%;"  value="<?php echo $vlQueryInfo[0]['sample_code'];?>" onblur="checkNameValidation('vl_request_form','sample_code',this,'<?php echo "vl_sample_id##".$id;?>','This sample code already exists.Try another number',null)"/>
                        </div>
                      </div>
                    </div>
		    <br/>
			...
			<td colspan="3">
		      ...
		      <tr><td colspan="2" style="font-size: 18px; font-weight: bold;">Section 5: Specimen information </td> <td colspan="4" style="font-size: 18px; font-weight: bold;"> Type of specimen to transport</td></tr>
                      <tr>
                        <td>
			...
			<td colspan="4" class="processTime"><label for="processTime">For onsite plasma processing only</label>
			 ...
			 <label class="radio-inline">
		      ...
		      <tr><td colspan="6" style="font-size: 18px; font-weight: bold;">CPHL Use Only </td></tr>
                      <tr>
			<td colspan="2" class="sampleQuality"><label for="breastfeeding">Specimen Quality</label>&nbsp;
			 <label class="radio-inline">
			...
			<td>
			 <label class="radio-inline">
			    <select name="laboratoryId" id="laboratoryId" class="form-control" title="Please choose lab name" style="width: 85%;">
                      ...
                      <tr>
			<td class="sampleType"><label for="sampleType">Specimen Type Received</label></td>
			<td>
			 <label class="radio-inline">
			...
			<td class=""><label for="testQuality">Specimen test quality</label></td>
			<td>
			  <label class="radio-inline">
			...
			<td class=""><label for="failedtestQuality">Specimen test quality</label></td>
			<td>
			  <label class="radio-inline">
