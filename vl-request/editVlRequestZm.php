...
//global config
$cSpecimenQuery="SELECT * FROM global_config";
        ...
        <div class="box-body">
          <!-- form start -->
                    ...
                    <div class="row">
                      <div class="col-xs-3 col-md-3">
                        ...
                        <label for="province">Region<span class="mandatory">*</span></label>
                          <select class="form-control isRequired" name="province" id="province" title="Please choose region" style="width:100%;" onchange="getfacilityDetails(this);">
			...
			<?php foreach($fResult as $fDetails){ ?>
                  ...
                  <div class="col-xs-3 col-md-3">
                    <div class="form-group">
                    <label for="sampleCollectionDate">Specimen Collection Date<span class="mandatory">*</span></label>
                    <input type="text" class="form-control isRequired" style="width:100%;" name="sampleCollectionDate" id="sampleCollectionDate" title="Please choose sample collection date" placeholder="Specimen Collection Date" value="<?php echo $vlQueryInfo[0]['sample_collection_date'];?>" onchange="checkSampleReceviedDate();checkSampleTestingDate();">
                    </div>
                  </div>
                  <div class="col-xs-3 col-md-3">
                    <div class="form-group">
                    <label for="">Specimen Received Date</label>
                    <input type="text" class="form-control" style="width:100%;" name="sampleReceivedDate" id="sampleReceivedDate" placeholder="Specimen Received Date" value="<?php echo $vlQueryInfo[0]['sample_received_at_vl_lab_datetime']; ?>" onchange="checkSampleReceviedDate();">
                    </div>
                  </div>
                </div>
                <div class="row">
                ...
                <div class="box box-primary">
                  <div class="box-body">
                    ...
                    <table class="table">
                      ...
                      <tr>
                        <td><label for="sampleTestingDateAtLab">Specimen Testing Date</label></td>
                        <td><input type="text" class="form-control " id="sampleTestingDateAtLab" name="sampleTestingDateAtLab" placeholder="Enter Specimen Testing Date." title="Please enter Specimen Testing Date" style="width:100%;" value="<?php echo $vlQueryInfo[0]['sample_tested_datetime'];?>" onchange="checkSampleTestingDate();"/></td>
                      ...
                      <tr class="noResult">
                        ...
                        <td colspan="2">
                          <label class="radio-inline noResult">
                             <input type="radio" class="" id="noResultRejected" name="noResult" value="sample_rejected" title="Choose result" <?php echo ($vlQueryInfo[0]['is_sample_rejected']=='sample_rejected')?"checked='checked'":""?> onclick='checkRejectionReason()'> Specimen Rejected
                          </label>
    ...
    function checkSampleTestingDate(){
      ...
      if($.trim(sampleCollectionDate)!= '' && $.trim(sampleTestingDate)!= '') {
        ...
        if(moment(sampleCollDateTime).diff(moment(sampleTestingAtLabDateTime)) > 0) {
          alert("Specimen Testing Date could not be earlier than Specimen Collection Date!");
