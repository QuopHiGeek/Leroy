                    ...
                    <div class="row">
                      <div class="col-xs-3 col-md-3">
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control isRequired <?php echo $numeric;?>" id="sampleCode" name="sampleCode" <?php echo $maxLength;?> placeholder="Enter Specimen Code" title="Please enter sample code" style="width:100%;" value="<?php echo $vlQueryInfo[0]['sample_code'];?>"/>
                        </div>
                      </div>
                    </div>
                    <div class="row">
                      ...
                      <div class="col-xs-3 col-md-3">
                        <div class="form-group">
                          <label for="fName">Site Name <span class="mandatory">*</span></label>
                            <select class="form-control isRequired" id="fName" name="fName" title="Please select site name" style="width:100%;" onchange="autoFillFacilityCode();">
                      ...
                      <div class="col-xs-3 col-md-3">
                        <div class="form-group">
                          <label for="fCode">Site Code </label>
                            <input type="text" class="form-control" style="width:100%;" name="fCode" id="fCode" placeholder="Site Code" title="Please enter site code" value="<?php echo $facilityResult[0]['facility_code'];?>">
                          </div>
                      </div>
                    </div>
                  ...
                  <div class="box-body">
                    ...
                    <table class="table">
                      ...
                      <tr>
                        ...
                        <td><input type="text" class="form-control labSection" id="sampleTestingDateAtLab" name="sampleTestingDateAtLab" placeholder="Enter Specimen Testing Date." title="Please enter Specimen Testing Date" value="<?php echo $vlQueryInfo[0]['sample_tested_datetime'];?>" style="width:100%;"/></td>
