             ...
             <div class="row">
                  <div class="col-md-6">
                    <div class="form-group">
                        <label for="facilityName" class="col-lg-4 control-label">Site Name </label>
                ...
                <div class="row">
                   ...
                   <div class="col-md-6">
                    <div class="form-group">
                        <label for="state" class="col-lg-4 control-label">Region</label>
                        <div class="col-lg-7" style="font-style:italic;">
         ...
         <div class="box box-primary">
            ...
            <div class="box-body">
             <div class="row">
                <div class="col-md-6">
                 ...
                 <div class="col-md-6">
                    <div class="form-group">
                        <label for="sampleCode" class="col-lg-4 control-label">Specimen Code </label>
                        <div class="col-lg-7" style="font-style:italic;">
                ...
                <div class="row">
                 <div class="col-md-6">
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                        <label for="patientName" class="col-lg-4 control-label">Patient's First Name </label>
                        <div class="col-lg-7" style="font-style:italic;">
                           <?php echo ucwords($result[0]['patient_first_name']); ?>
                        </div>
                    </div>
                    
                    <!-- New Patient Middle Name Code -->
                     <div class="form-group">
                        <label for="patientName" class="col-lg-4 control-label">Patient's Middle Name </label>
                        <div class="col-lg-7" style="font-style:italic;">
                           <?php echo ucwords($result[0]['patient_middle_name']); ?>
                        </div>
                    </div>
                    
                     <div class="form-group">
                        <label for="patientName" class="col-lg-4 control-label">Patient's Last Name </label>
                        <div class="col-lg-7" style="font-style:italic;">
                           <?php echo ucwords($result[0]['patient_last_name']); ?>
                        </div>
                    </div>
                  </div>
                </div>
            ...
            <div class="box-body">
              <div class="row">
                    <div class="col-md-6">
                    <div class="form-group">
                        <label class="col-lg-4 control-label">Specimen Collected On</label>
                        <div class="col-lg-7" style="font-style:italic;">
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                        <label for="sampleType" class="col-lg-4 control-label">Specimen Type </label>
                        <div class="col-lg-7" style="font-style:italic;">
          ...
          <div class="box box-success">
             ...
             <div class="row">                
                ...
                <?php if($result[0]['reason_for_vl_testing']=='routine'){ ?>
                  <div class="row">
                     ...
                     <div class="col-md-4">
                      <div class="form-group">
                          <label for="rmTestingSampleType" class="col-lg-4 control-label">Specimen Type</label>
                          <div class="col-lg-7" style="font-style:italic;">
                ...
                <?php } elseif($result[0]['reason_for_vl_testing']=='failure'){ ?>
                    <div class="row">
                      ...
                      <div class="col-md-4">
                       <div class="form-group">
                           <label for="repeatTestingSampleType" class="col-lg-4 control-label">Specimen Type</label>
                           <div class="col-lg-7" style="font-style:italic;">
                ...
                <?php } elseif($result[0]['reason_for_vl_testing']=='suspect'){ ?>
                   ...
                   <div class="col-md-4">
                    <div class="form-group">
                        <label for="suspendTreatmentSampleType" class="col-lg-4 control-label">Specimen Type</label>
                        <div class="col-lg-7" style="font-style:italic;">
            ...
            <div class="box-body">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                    <div class="form-group">
                        <label for="" class="col-lg-4 control-label">Date Specimen Received at Testing Lab</label>
                        <div class="col-lg-7" style="font-style:italic;">
                ...
                <div class="row">
                 <div class="col-md-6">
                    <div class="form-group">
                        <label for="" class="col-lg-4 control-label">Specimen Testing Date</label>
                        <div class="col-lg-7" style="font-style:italic;">
                           <?php echo $result[0]['sample_tested_datetime']; ?>
                        </div>
                    </div>
