                 ...
                 <div class="box box-primary">
                    ...
                    <div class="box-body">
                      ...
                      <div class="row">
                        <div class="col-xs-4 col-md-4">
                          <div class="form-group">
                          <label for="fCode">Site ID </label>
                            <input type="text" class="form-control" style="width:100%;" name="fCode" id="fCode" placeholder="Health Site Code" title="Please enter health site code">
                          </div>
                        </div>
                        <div class="col-xs-4 col-md-4">
                          <div class="form-group">
                      ...
                      <div class="col-xs-4 col-md-4">
                          ...
                          <label for="result">Results </label>
                            <select name="result" id="result" class="form-control" title="Please choose test result" style="width:100%;">
                              ...
                              <option value="repeat">Repeat Specimen Collection</option>
                            </select>
