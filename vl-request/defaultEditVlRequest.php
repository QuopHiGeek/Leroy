...
<!-- Content Wrapper. Contains page content -->
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1><i class="fa fa-edit"></i> eLabMessenger LABORATORY REQUEST FORM </h1>
      <ol class="breadcrumb">
        ...
        <div class="box-body">
          <!-- form start -->
			...
			<div class="col-xs-3 col-md-3">
                        <div class="form-group">
                          <label for="ageInYears">If DOB unknown, Age in Year </label>
                            <input type="text" name="ageInYears" id="ageInYears" class="form-control checkNum isRequired" maxlength="2" placeholder="Age in Year" title="Enter age in years"  value="<?php echo $vlQueryInfo[0]['patient_age_in_years'];?>"/>
                          </div>
                      </div>
                    </div>
                    <div class="row">
                    ...
                    <div class="box-body">
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="col-lg-7">
                              <select name="testLab" id="testLab" class="form-control labSection" title="Please choose lab" onchange="autoFillFocalDetails();">
                               ...
                               <option value="Sekondi Public Health Laboratory">Sekondi Public Health Laboratory</option>
                      ...
                      <div class="row">
                        ...
                        <div class="col-md-4 rejectionReason" style="display:<?php echo($vlQueryInfo[0]['is_sample_rejected'] == 'yes')?'':'none'; ?>;">
                            <label class="col-lg-5 control-label" for="rejectionReason">Rejection Reason </label><p style="color:red;">Hold <b>Ctrl</b> to select multiple reasons</p>
                            <div class="col-lg-15">
