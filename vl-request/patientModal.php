...
?>
										...
										foreach($pResult as $patient){
											...
											?>
												<tr>
													 ...
													 <td><?php echo $patient['patient_middle_name'];?></td>
  ...
  $(document).ready(function() {
    ...
    function getPatientDetails(pDetails){
      ...
      if(typeof parent.setIsPatientNew == 'function') parent.setIsPatientNew(false);  
    }
