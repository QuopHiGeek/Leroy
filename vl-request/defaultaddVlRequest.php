...
<!-- Content Wrapper. Contains page content -->
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1><i class="fa fa-edit"></i> TEST REGISTRATION FORM </h1>
      <ol class="breadcrumb">
        <li><a href="../dashboard/index.php"><i class="fa fa-dashboard"></i> Home</a></li>
        <li class="active">Add Test Request</li>
      </ol>
    </section>
                    ...
                    <div class="widget-content">
                        <div class="bs-example bs-example-tabs">
                            <ul id="myTab" class="nav nav-tabs">
                                <li class="active"><a href="#clinicInformation" data-toggle="tab">Laboratory Information</a></li>
...
<!--                                <li><a href="#laboratoryInformation" data-toggle="tab">Laboratory Information</a></li>-->
                            ...
                            <div id="myTabContent" class="tab-content" >
                                <div class="tab-pane fade in active" id="clinicInformation">
                                    <div class="box-body">
                                        <div class="box box-primary">
                                            <div class="box-header with-border">
                                                <h3 class="box-title">Laboratory Information: (To be filled by requesting Clinican/Nurse)</h3>
                                            </div>
                                            <div class="box-body">
                                                <div class="row">
                                ...
                                <div class="tab-pane fade" id="specimenInformation">
                                    ...
                                    <a class="btn btn-primary next-btn" name="treatBtn" id="treatBtn" target-tab="treatmentInformation" >Save and Next </a>
                                    <a href="vlRequest.php" class="btn btn-default"> Cancel</a>
                                    </div>
                                </div>
                                                    ...
                                                    <div class="col-xs-3 col-md-3">
                                                        <div class="form-group">
                                                            <label for="artRegimen">Current Regimen</label>
                                                                <select myselect multiple class="form-control js-example-basic-multiple" id="artRegimen" name="artRegimen" title="Please choose ART Regimen" style="width:100%;" onchange="checkARTValue();">
                                                               <option value="">-- Select --</option>
