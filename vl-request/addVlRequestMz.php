              ...
              <div class="box-body">
                ...
                <br/>
                    <table class="table" style="width:100%">
                      ...
                      <tr>
                        <td><label for="sampleCollectionDate">Specimen Collection Date </label></td>
                      ...
                      <tr>
                        <td><label for="sampleReceivedBy">Specimen Received by </label></td>
                        <td>
                        ...
                        <td><label for="sampleReceivedDate">Specimen Received On</label></td>
                        ...
                        <td><label for="receiveSms">Specimen Process </label></td>
                        <td>
                          <label class="radio-inline">
                             <input type="radio" class="" id="receivesmsYes" name="receiveSms" value="yes" title="Patient consent to receive SMS"> Yes
                          </label>
                      ...
                      <tr>
                        ...
                        <td colspan="2"><label>If Specimen not processed what is the reason</label></td>
                        <td colspan="2">
