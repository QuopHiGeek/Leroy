...
include_once '../config/MysqliDb.php';
...
$sOrder = "b.request_created_datetime";
...
foreach ($rResult as $aRow) {
    ...
    $row['batchCode'] = ucwords($aRow['batch_code']);
    $row['batchID'] = $aRow['batch_id'];
    $row['noOfSpecimen'] = $aRow['sample_code'];
    $row['noOfTestedSpecimen'] = $noOfSampleResultCount[0]['no_of_sample_tested'];
    $row['noOfSpecimenLowLevel'] = $noOfSampleLowResultCount[0]['no_of_sample_low_tested'];
    $row['noOfSpecimenHighLevel'] = $noOfSampleHighResultCount[0]['no_of_sample_high_tested'];
    $row['lastTestedDate'] = $date;
    $row['createdOn'] = $humanDate;
