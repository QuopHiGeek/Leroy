 ...
 //           print_r($admin[0]); die;
            ...
            if($priInfo){
              ...
              if($admin[0]['landing_page']!=''){
                ...
                $fileNameList = array('index.php','addVlRequest.php','vlRequest.php','batchcode.php','vlRequestMail.php','addImportResult.php','vlPrintResult.php','vlPrintDBSResult.php','vlTestResult.php','missingResult.php','vlResult.php','highViralLoad.php','roles.php','users.php','facilities.php','globalConfig.php','importConfig.php');
                $fileName = array('dashboard/index.php','vl-request/addVlRequest.php','vl-request/vlRequest.php','batch/batchcode.php','mail/vlRequestMail.php','import-result/addImportResult.php','vl-print/vlPrintResult.php','vl-print/vlPrintDBSResult.php','vl-print/vlTestResult.php','program-management/missingResult.php','program-management/vlResult.php','program-management/highViralLoad.php','roles/roles.php','users/users.php','facilities/facilities.php','global-config/globalConfig.php','import-configs/importConfig.php');
