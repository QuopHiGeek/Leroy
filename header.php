...
&& end($link_array)!='editUserHelper.php' && end($link_array)!='users.php' && end($link_array)!='offSiteRequestRecords.php' && end($link_array)!='offSiteResultRecords.php' && end($link_array)!='vlEditPrintResult.php' && end($link_array)!='eidDashboard.php' && end($link_array)!='searchPatient.php' && end($link_array)!='vlPrintDBSResult.php'){
  ...
  <header class="main-header">
   ...
   <!--   <span class="">eLabMessenger</span> -->
    ...
    if($_SESSION['roleId']==3){
     ...
     $tdt = DATE('Y-m-d');
      //Get today tests
      $tdresults =  $db->rawQuery("select COUNT(vl_sample_id) as total FROM vl_request_form WHERE DATE (sample_tested_datetime) >= (CURDATE() -INTERVAL 3 DAY)");
      foreach($tdresults as $t){
        echo "<a style='float:right;width: 55px;height:50px; color:red; line-height: 1.33;border-radius: 25px;' href='#' class='btn btn-info btn-lg blinking'>
    ...
    $tdt = DATE('Y-m-d');
      //Get today tests
      $tdresults =  $db->rawQuery("select COUNT(vl_sample_id) as total FROM vl_request_form WHERE DATE (sample_tested_datetime) >= (CURDATE() -INTERVAL  3 DAY) AND facility_id='$siteid'");
      foreach($tdresults as $t){
        echo "<a style='float:right;width: 55px;height: 50px; color:red; line-height: 1.33;border-radius: 25px;' href='#' class='btn btn-info btn-lg blinking'>
                  <span class='glyphicon glyphicon-bell' style='mergin-right:90px;'>".$t['total']."</span>
                </a>";
            ...
            <ul class="treeview-menu">
              ...
              <?php } if(isset($_SESSION['privileges']) && in_array("addImportTestResult.php", $_SESSION['privileges'])){ ?>
                  <li class="allMenu importTestResultMenu">
                    <a href="../vl-request/addImportTestResult.php"><i class="fa fa-circle-o"></i> Billing </a>
                  </li>
              <?php } ?>
            </ul>
        </li>
            ...
            <li class="treeview program">
                ...
                <!--    <li class="allMenu missingResultMenu"><a href="../program-management/missingResult.php"><i class="fa fa-circle-o"></i> Specimen Status Report</a></li>
                   ...
                   <!--  <li class="allMenu vlResultMenu"><a href="../program-management/vlResult.php"><i class="fa fa-circle-o"></i> Export Results</a></li> -->
                    ...
                    <li class="allMenu vlPrintResultMenu"><a href="../vl-print/vlPrintResult.php"><i class="fa fa-circle-o"></i> Patient Report </a></li>
                    <?php } if(isset($_SESSION['privileges']) && in_array("vlPrintResult.php", $_SESSION['privileges'])){ ?>
                   <!--  <li class="allMenu vlPrintDBSResultMenu"><a href="../vl-print/vlPrintDBSResult.php"><i class="fa fa-circle-o"></i> Print DBS Results</a></li> -->
                    ...
                    <!-- <li class="allMenu vlWeeklyReport"><a href="../program-management/vlWeeklyReport.php"><i class="fa fa-circle-o"></i> VL Weekly</a></li> -->
                    <?php } if(isset($_SESSION['privileges']) && in_array("sampleRejectionReport.php", $_SESSION['privileges'])){ ?>
                 <!--   <li class="allMenu sampleRejectionReport"><a href="../program-management/sampleRejectionReport.php"><i class="fa fa-circle-o"></i> Sample Rejection</a></li> -->
                    <?php } if(isset($_SESSION['privileges']) && in_array("vlMonitoringReport.php", $_SESSION['privileges'])){ ?>
                     <li class="allMenu vlMonitoringReport"><a href="../program-management/vlMonitoringReport.php"><i class="fa fa-circle-o"></i> Daily Log</a></li>
                    <?php } if(isset($_SESSION['privileges']) && in_array("vlShipmentReport.php", $_SESSION['privileges'])) { ?>
                 <!--  <li class="allMenu vlShipmentReport"><a href="../program-management/vlShipmentReport.php"><i class="fa fa-circle-o"></i> VL Shipment Report</a></li> -->
                    <?php } if(isset($_SESSION['privileges']) && in_array("vlPivotTable.php", $_SESSION['privileges'])) { ?> 
                    <li class="allMenu vlPivotTable"><a href="../vl-print/vlPivotTable.php"><i class="fa fa-circle-o"></i> Aggregate Report</a></li>
